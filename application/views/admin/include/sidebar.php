    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li id="users" class="treeview">
            ...
            <ul class="treeview-menu">
              <!--<li id="add_user"><a href="<?= base_url('admin/users/add'); ?>"><i class="fa fa-circle-o"></i> Agregar Usuario</a></li>-->
              <li id="view_users" class=""><a href="<?= base_url('admin/users'); ?>"><i class="fa fa-circle-o"></i> Usuarios</a></li>
              <!--<li id="add_user"><a href="<?= base_url('admin/roles/add'); ?>"><i class="fa fa-circle-o"></i> Agregar Rol</a></li>-->
              <li id="view_roles" class=""><a href="<?= base_url('admin/roles'); ?>"><i class="fa fa-circle-o"></i> Roles</a></li>
            </ul>
          </li>
